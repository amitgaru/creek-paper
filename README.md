...
Creek is a Geo-replicated database system where one can achieve Linearizability for the Strong Operations and Fluctuating Eventual Consistency for the Weak Operations with the fault tolerance of $f < \frac{N}{2}$ nodes.
